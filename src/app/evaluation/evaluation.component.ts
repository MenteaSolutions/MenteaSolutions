...
export class EvaluationComponent implements OnInit {
  ...
  onSubmit() {
    ...
    const atLeastOneFieldFilled = Object.values(formValues).some(value => value !== '' && value !== false);
    ...
    const templateParams = {
      ...
      LaFormationsuiviePasencore: formValues.LaFormationsuiviePasencore ? 'Oui' : 'Non',
      ...
      JugerEnseignementBasique: formValues.JugerEnseignementBasique ? 'Oui' : 'Non',
      JugerEnseignementMoyen: formValues.JugerEnseignementMoyen ? 'Oui' : 'Non',
      JugerEnseignementBon: formValues.JugerEnseignementBon ? 'Oui' : 'Non',
      JugerEnseignementExcellent: formValues.JugerEnseignementExcellent ? 'Oui' : 'Non',
      ...
      CompetancesProfessionelles: formValues.CompetancesProfessionelles || 'Non spécifié',
      ...
      ApprecieFormation: formValues.ApprecieFormation || 'Non spécifié',
       ...
       commentairesEnseignants: formValues.commentairesEnseignants || 'Non spécifié',
       ...
       tresBonne: formValues.tresBonne ? 'Oui' : 'Non',
        ...
        moduleTravailtresUtile: formValues.moduleTravailtresUtile ? 'Oui' : 'Non',
        dureModuleOui: formValues.dureModuleOui ? 'Oui' : 'Non',
        dureModuleNon: formValues.dureModuleNon ? 'Oui' : 'Non',
        dureModulesouhaitable: formValues.dureModulesouhaitable || 'Non spécifié',
        ...
        dossierProjettresUtile: formValues.dossierProjettresUtile ? 'Oui' : 'Non',
        ...
        comm: formValues.comm || 'Aucun commentaire',
                ...
                formationVosAttentes7: formValues.formationVosAttentes7 || 'Non spécifié',
                classerNomadesNesaispas: formValues.classerNomadesNesaispas ? 'Oui' : 'Non',
              ...
              emailjs.send('service_kp6gkt5', 'template_fc91b75', templateParams, 'Zo5MFAabBvPWZ_u9t')
              .then((response: EmailJSResponseStatus) => {
                ...
                window.alert('Dështoi dërgimi i formularit. Ju lutem provoni përsëri.');
              });
          } else {
            // Trego një mesazh nëse nuk është plotësuar asnjë fushë
            window.alert('Ju lutem plotësoni të paktën një fushë për të dërguar formularin.');
          }
        }
        }